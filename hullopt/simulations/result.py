...
class Result:
    ...
    reserve_buoyancy_hull - kg (float): the reserve buoyancy that the unsubmerged portion of hull contributes to (or against, if the hull is more dense than water)
